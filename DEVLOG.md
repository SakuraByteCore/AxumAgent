...
- Reworked the runtime dashboard into a direct workflow workbench with current phase, now/next action, step timeline, evidence, commands, files, and blockers so users can tell what the TUI is doing from a static screen.
