...
- [x] Render TUI runtime work as auditable Activity/Commands/Files/Blocked sections with redacted/folded command output, human-readable Working timers, latest-activity status, raw pi-tui input without the legacy boxed Prompt panel, and quick repeated-denial stops.
