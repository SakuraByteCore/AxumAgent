...
export class UserAgentWidget {
	...
	constructor(
		...
		sendSquashedResult: (message: AgentResultMessage) => void,
		announceDetached: (sessionId: string) => void,
		rebaseDelivery: RebaseDelivery,
	) {
		this.runningAgents = runningAgents;
		this.sendSquashedResult = sendSquashedResult;
		this.announceDetached = announceDetached;
		this.rebaseDelivery = rebaseDelivery;
	}
