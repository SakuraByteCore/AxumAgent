...
export class AgentViewer implements Component {
	...
	constructor(
		...
		agent: ViewableAgent,
		theme: Theme,
		done: (result: AgentViewerAction) => void,
		...
		this.theme = theme;
		this.done = done;
		this.canSquashMainContext = canSquashMainContext;
		this.squashMainContext = squashMainContext;
		this.canRebaseMainContext = canRebaseMainContext;
		this.rebaseMainContext = rebaseMainContext;
		this.rebaseBlockReason = rebaseBlockReason;
		this.rebaseDetachCount = rebaseDetachCount;
