...
:root{color-scheme:light dark;--bg:#f6f7fb;--bg2:#eef2f8;--panel:rgba(255,255,255,.94);--panel2:#f8fafc;--text:#111827;--muted:#5f6b7a;--line:#d8e0ea;--accent:#6d5dfc;--accentText:#fff;--ok:#15803d;--err:#dc2626;--badgeBg:#eef2ff;--badgeText:#4f46e5;--badgeLine:#c7d2fe;--inputBg:#fff;--inputText:#111827;--shadow:#0f172a24;--statusOkBg:#ecfdf3;--statusOkText:#166534;--statusOkLine:#bbf7d0;--statusErrBg:#fef2f2;--statusErrText:#991b1b;--statusErrLine:#fecaca;--warn:#a16207;--warnBg:#fef9c3}*{box-sizing:border-box}body{margin:0;background:radial-gradient(circle at top left,var(--bg2) 0,var(--bg) 45%,var(--bg) 100%);color:var(--text);font:14px/1.45 Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;min-height:100vh;display:grid;place-items:center;padding:28px}.shell{width:min(980px,100%);display:grid;grid-template-columns:1fr 300px;background:var(--panel);border:1px solid var(--line);border-radius:22px;box-shadow:0 30px 100px var(--shadow);overflow:hidden}.main{padding:30px}.side{background:var(--panel2);border-left:1px solid var(--line);padding:28px}h1{font-size:24px;margin:0 0 8px;letter-spacing:-.03em}p{color:var(--muted);margin:0}.badge{display:inline-block;background:var(--badgeBg);color:var(--badgeText);border:1px solid var(--badgeLine);border-radius:999px;padding:4px 9px;font-size:12px;margin-bottom:14px}.divider{height:1px;background:var(--line);margin:20px 0}.field{display:grid;gap:7px;margin:14px 0}.field label{font-weight:700;color:var(--text)}.field input,.field select{width:100%;height:44px;border-radius:11px;border:1px solid var(--line);background:var(--inputBg);color:var(--inputText);padding:0 13px;outline:none}.field input:focus,.field select:focus{border-color:var(--accent);box-shadow:0 0 0 3px color-mix(in srgb,var(--accent) 22%,transparent)}.row{display:flex;gap:10px;align-items:center}.btn{height:42px;border:0;border-radius:11px;background:var(--accent);color:var(--accentText);font-weight:800;padding:0 16px;cursor:pointer}.btn.secondary{background:var(--panel2);color:var(--text);border:1px solid var(--line)}.btn.ok{background:var(--ok);color:white;width:100%}.btn:disabled{opacity:.55;cursor:not-allowed}.hint{font-size:12px;color:var(--muted)}.status{border-radius:13px;padding:13px;margin-top:14px;display:none}.status.ok{display:block;border:1px solid var(--statusOkLine);background:var(--statusOkBg);color:var(--statusOkText)}.status.err{display:block;border:1px solid var(--statusErrLine);background:var(--statusErrBg);color:var(--statusErrText)}.step{display:flex;gap:10px;margin:15px 0;color:var(--muted)}.step i{width:22px;height:22px;border-radius:50%;background:var(--line);display:grid;place-items:center;font-style:normal;font-size:12px}.step.done i{background:var(--ok);color:white}.step.err i{background:var(--err);color:white}.manual{display:none}.manual.show{display:grid}.footer{color:var(--muted);font-size:12px;margin-top:18px}.secret-note{color:var(--warn);background:var(--warnBg);border-radius:10px;padding:8px 10px;font-size:12px;margin-top:8px}@media(prefers-color-scheme:dark){:root{--bg:#080b10;--bg2:#1e2a45;--panel:rgba(18,24,36,.96);--panel2:#0d121a;--text:#eef2f7;--muted:#8b95a7;--line:#2b364b;--accent:#7c5cff;--badgeBg:#162236;--badgeText:#93c5fd;--badgeLine:#28446b;--inputBg:#0b0f16;--inputText:#eef2f7;--shadow:#0009;--statusOkBg:#0d2117;--statusOkText:#bbf7d0;--statusOkLine:#205c38;--statusErrBg:#251111;--statusErrText:#fecaca;--statusErrLine:#6b2a2a;--warn:#fbbf24;--warnBg:transparent}}@media(max-width:760px){.shell{grid-template-columns:1fr}.side{border-left:0;border-top:1px solid var(--line)}}
